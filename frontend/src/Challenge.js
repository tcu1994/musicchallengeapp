...
export default function Challenge() {
    ...
    return (<div>
        ...
        <div style={{height : 'auto', float: 'left'}}>
            ...
            <img id="image" style={{marginTop : '30px',marginLeft : '40px', maxHeight : `400px`, width : 'auto', maxWidth : `${window.innerWidth / 3}px`, height : 'auto'}} src={challenge.photoURL}/>
        ...
        <div style={{paddingTop : '100px',color : 'white', float : 'right', paddingRight : challenge?.entries?.length > 0 ? `${window.innerWidth / 10}px` : '50px'}}>
