...
export default function Challenge() {
    ...
    return(<div>
        ...
        <Link style={{background : 'black', borderRadius : '0px', marginTop : '8px', color: 'white', float :'right', marginRight : '100px'}} className="ui button" to="/">
                Back
            </Link>
        ...
        <h1 style={{paddingLeft : '20px',color: 'white'}}className="ui header">Your profile </h1>
          :
          <h1 style={{paddingLeft : '20px',color: 'white'}}className="ui header">
        ...
        <table style={{paddingLeft : '15px',color: 'white'}} class="ui very basic collapsing celled table">
        <thead>
        ...
        {user?.entries?.length > 0 ? user.entries.slice(offset,offset+ 5).map((entry,i) => {
                return <tr >
                    ...
                    <td id="profileWave" style={{color: 'white',width : '500px'}}><Waveform send={send} pause={pause}id={i}url={entry.songURL} plays={entry.plays}
                    /> </td>
                </tr>
        ...
        <table style={{  border : 'none',padding: '5px',color: 'white',float : 'left', position : 'absolute', top : '190px', left : '800px'}}class="ui very basic collapsing celled table">
