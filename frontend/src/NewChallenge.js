...
export default function Challenge() {
    ...
    return (<div>
        ...
        <Link style={{borderRadius : '0px', marginTop : '8px',backgroundColor : 'black', color: 'white', float :'right', marginRight : '100px'}}className="ui button" to="/">
                Back
            </Link>
        </div>
        <h1 style={{marginTop : '0px',backgroundColor : 'black', color: 'white',paddingLeft : '20px', display: 'inline-block'}}className="ui header">Add new challenge: </h1>
