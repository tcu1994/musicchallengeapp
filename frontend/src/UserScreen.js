...
class UserScreen extends React.Component {
    ...
    render(){
        ...
        let renderChallenges = challenges.map((challenge)=> {
            return (<div className="ui card"style={{backgroundColor : 'black', color : 'white',  borderRadius : '0px',maxHeight : '270px', maxWidth : '200px', justifyContent: 'center',alignItems: 'center', zIndex : '11', border : 'none', overflow : 'hidden', cursor: 'pointer', boxShadow : 'none' }}>
                ...
                <div  style = {{padding : '0px', justifyContent: 'center',alignItems: 'center' }}className="ui middle aligned center aligned content">
                        ...
                        {challenge.photoURL ? <div style={{overflow : 'hidden', width : '200px', height : '200px',display : 'flex', justifyContent: 'center'}}>
                             ...
                             :
                             <Link to={`/challenge/${challenge._id}`}><div style={{ color : 'white',paddingTop : '5px', height : '200px', width : '200px',display : 'flex', justifyContent: 'center',alignItems: 'center'}}className="description">{challenge.text.substring(0, 200)}</div></Link> }
        ...
        return (<div>
            ...
            {localStorage.isAuthenticated == 'true' ? <div  style={{ width : '600px', display: 'inline-block', float : 'right', marginRight : '50px'}}>
            ...
            <Link style={{borderRadius : '0px', marginTop : '8px',color: 'white',background : 'black'}}className="ui button" to={"/donate"}>
                Donate
            </Link>
            </div>
                 : 
            <div style={{ width : '300px', display: 'inline-block', float : 'right', marginRight : '50px', marginTop :'10px'}}>
                ...
                <Link style={{borderRadius : '0px', marginTop : '0px',color: 'white',background : 'black'}}className="ui button" to={"/donate"}>
                Donate
            </Link>
            </div>
